					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-12 form-field">
								...
								<select	id="accSupBy" name="accSupBy" disabled class="form-control">
...
<script type="text/javascript" src='<c:out value="${pageContext.servletContext.contextPath}" />/resource/oe/assets/js/app/accSearchREN.js'></script>
