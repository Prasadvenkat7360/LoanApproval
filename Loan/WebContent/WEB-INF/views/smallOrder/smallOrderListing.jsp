<!-- 
	##	Author UI       : 	Raksha
	##  JAVA            :   Nageshwar Rao
	##	Date Creation 	: 	07-03-2018
	## 	Description		:	Small Order Listing
 -->
		...
		<div class="row">
			<div class="col-md-12  layout-main">
				...
				<div class="heading-block">
					<h1>
						<i class="fa fa-desktop"></i> &nbsp; Small Order Listing
					</h1>
				</div>
...
<script src="resource/oe/assets/js/app/smallOrderListing.js" type="text/javascript"></script>
