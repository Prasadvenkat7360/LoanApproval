		...
		<div class="row">
			...
			<div class="col-md-12  layout-main">
				<div class="heading-block">
					<h1>
						<i class="fa fa-desktop"></i> Design Review Approval
					</h1>
				</div>
				...
				<form class="form-horizontal" id="designRA">
						<div class="row">
							<div class="col-sm-2">
								...
								<div class="input-group">
									...
									name= "orderFromDate"id="orderFromDate" placeholder="DD/MM/YYYY"> <label
							...
							<div class="col-sm-2">
								...
								<div class="input-group">
									<input type="text" readonly = 'true' class="date-picker form-control dateBackground"
										name = "orderToDate" id="orderToDate" placeholder="DD/MM/YYYY"> <label
						...
						<div class="row voffset2" align="center">
							<button class="btn btn-primary btn-sm voffset" type="button" name="SearchDAppr" id="SearchDAppr"><i class="fa fa-search fa-lg"></i> Search</button>
...
<div class="modal fade" id="btnReviewDA" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="padding-top: 10%;">
...
function enableDesigner(){	
	...
	$.getJSON('/OrderExecution/api/v1/designLOV?page=DesignRevApprove',
			function(data) {		
				...
				$.each(data.payload.designBy, function(key, val) {
					$designBy.append('<option value="' + val.id + '">'
							+ val.name + '</option>');
				});
	...
	$("#Save").on(
			"click",
			function() {
				postJSON('/OrderExecution/api/v1/dReviewApprovalList', JSON
