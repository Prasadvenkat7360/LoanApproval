		...
		<div class="row">
			<div class="col-md-12  layout-main">
				...
				<div class="heading-block">
					<h1 id="home"><i class="fa fa-desktop"></i> &nbsp; Vendor MAS Metal Detail </h1>
				</div>
					<form class="form-horizontal" id="raiseTvForm">
						...
						<div class="row">
							<div class="col-sm-2">
									<span class="required">*</span>&nbsp;<label>Vendor Type</label>
									<select id="vTypeS" name="vTypeS" class="form-control">
										<option value="" selected label="Select" />
									</select>
								</div>
								<div class="col-sm-2">
									<span class="required">*</span>&nbsp;<label>Vendor Code</label>
									<select id="vCodeS" name="vCodeS" class="form-control">
										<option value="" selected label="Select" />
									</select>
								</div>
								<div class="col-sm-2">
							   ...
							   <div class="col-sm-2">
								...
								<div class="col-sm-2">
									...
									<select id="msegS" name="msegS" class="form-control">
										<option value="" selected label="Select" />
									</select>
								</div>
								<div class="col-sm-2">
									<span class="required">*</span>&nbsp;<label>JW Type</label>
									<select id="jwType" name="jwType" class="form-control">
										<option value="" selected label="Select" />
									</select>
								</div>
					...
					<div class="panel with-nav-tabs panel-primary">
									...
									data-toggle="tab"><i class="fa fa-user fa-lg"></i> MAS</a></li>
										...
										<!-- <li id="issueFg"><a
											href="#tab2primary" data-toggle="tab"><i
												class="fa fa-filter fa-lg"></i> Issue Finished Goods</a></li> -->
								
										<li id="issueRm"><a
											href="#tab3primary" data-toggle="tab"><i
												class="fa fa-filter fa-lg"></i> Issue Raw Materials Regular/System </a></li>
												
										<li id="issueFr"><a
											href="#tab4primary" data-toggle="tab"><i
												class="fa fa-filter fa-lg"></i> Issue Finished Regular</a></li>
												
										<li id="issueFsm"><a
											href="#tab5primary" data-toggle="tab"><i
												class="fa fa-filter fa-lg"></i> Issue Finished System</a></li>
												
										<!-- <li id="receiptRm"><a
											href="#tab6primary" data-toggle="tab"><i
												class="fa fa-filter fa-lg"></i> Receipt Raw Material </a></li> -->
						...
						<div class="clearfix">&nbsp;</div>
								...
								<div class="tab-pane fade" id="tab2primary">
									<div class="row">
										<h5 style="margin-left: 18px;font-weight: 600; color: #0065aa;"><i class="fa fa-list"></i>&nbsp;&nbsp;<u id="issHeading">Issue Detail Statement - FG </u></h5>
								...
								<div class="tab-pane fade" id="tab3primary">
									<div class="row">
										<h5 style="margin-left: 18px;font-weight: 600; color: #0065aa;"><i class="fa fa-list"></i>&nbsp;&nbsp;<u id="issHeading">Issue Detail Statement - RM </u></h5>
								...
								<div class="tab-pane fade" id="tab4primary">
									<div class="row">
										<h5 style="margin-left: 18px;font-weight: 600; color: #0065aa;"><i class="fa fa-list"></i>&nbsp;&nbsp;<u id="issHeading">Issue Finished Regular </u></h5>
								...
								<div class="tab-pane fade" id="tab5primary">
									<div class="row">
										<h5 style="margin-left: 18px;font-weight: 600; color: #0065aa;"><i class="fa fa-list"></i>&nbsp;&nbsp;<u id="issHeading">Issue Finished System </u></h5>
...
<script src="resource/oe/assets/js/app/vendorMasDetailReport.js" type="text/javascript"></script>
<style>
	.dateBackground
	{
