<!--  	
	...
	## 	Description		:	Creation of Print Tags-Loose Stone 
 -->
		...
		<div class="row">
			...
			<div class="col-md-12  layout-main">
				<div class="heading-block">
					<h1>
						<i class="fa fa-desktop"></i> &nbsp; Print Tag-Loose Stone 
					</h1>					
				</div>
				<form class="form-horizontal" id="looseStoneSearch" action="javascript: void(0);">
						<div class="row">
							<div class="col-sm-2">
								<label>GR No.</label>
							...
							<div class="col-sm-2" id="tozoneObj" >
						 	...
						 	<div class="col-sm-2">
							    ...
							    <select name="stoneSeg"  id="stoneSeg" class="form-control" >
							    	<option value="">--Select--</option>
							    </select>					    
						    </div>
						    <div class="col-sm-2">
						...
						<div class="row voffset2" align="center">
							 ...
							 <button id="clearAll" class="btn btn-warning btn-sm voffset" type="reset">								
								...
								&nbsp;
							 <button name="printTagLS" id="printTagLS" type="button" class="btn btn-primary btn-sm voffset">								
...
<script type="text/javascript" src="resource/oe/assets/js/app/looseStonePrintTag.js"></script>