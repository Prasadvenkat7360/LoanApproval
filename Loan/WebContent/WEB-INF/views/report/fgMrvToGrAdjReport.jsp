		...
		<div class="row">
			...
			<div class="col-md-12  layout-main">
				<div class="heading-block">
					<h1>
						<i class="fa fa-desktop"></i> &nbsp; (FG) GRV To IGR,GIV & MDV Report
					</h1>
				</div>
				...
				<form class="form-horizontal" id="MetalAccLocSearch">
						...
						<div class="row">
							...
							<div class="col-sm-2">
								<label>GRV Type</label> <div id="mrvTypeS"></div>
						...
						<div class="row voffset2" align="center">
							...
							&nbsp;
							 <button name="printfgmrvgr" id="printfgmrvgr" type="button"class="btn btn-primary btn-sm voffset">								
...
<div class="modal fade" id="viewfgMrvSearchGridModal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"	style="padding-top: 2%;">
...
<script src="resource/oe/assets/js/app/fgMrvToGrAdjReport.js"></script>
