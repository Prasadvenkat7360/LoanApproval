		...
		<div class="row">
			<div class="col-md-12  layout-main">
				...
				<div class="heading-block">
					<h1 id="home">
						<i class="fa fa-desktop"></i> &nbsp; Transaction Alert Template
					</h1>
					...
					<div>
						<div class="col-sm-12">
							...
							<div class="row" id="row1">
								...
								<div class="col-sm-2 " style="display: none;" id="refereMe">
...
<script src="resource/oe/assets/js/app/transactionAlertTemplate.js"
