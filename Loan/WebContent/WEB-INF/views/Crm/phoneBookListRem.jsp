		...
		<div class="row">
			<div class="col-md-12  layout-main">
				...
				<div class="heading-block">
					<h1>
						<i class="fa fa-desktop"></i> &nbsp; Phone List Print For Reminder 
					</h1>
				</div>
								...
								<div class="col-sm-2">
									<span class="required">*</span>&nbsp;<label>From Date</label>
										<div class="input-group"><input type="text"  readonly = 'true' class="date-picker form-control dateBackground"
										 name="fromDateR" id="fromDateR" placeholder="DD/MM/YYYY">
										<label for="fromDateR" class="input-group-addon cursor"><span class="fa fa-calendar"></span></label>
								       </div>
							   </div>
							   <div class="col-sm-2">
									<span class="required">*</span>&nbsp;<label>To Date</label>
										<div class="input-group"><input type="text"  readonly = 'true' class="date-picker form-control dateBackground"
										name="toDateR" id="toDateR" placeholder="DD/MM/YYYY">
										<label for="toDateR" class="input-group-addon cursor"><span class="fa fa-calendar"></span></label>
										</div>
								</div>
						</div>
						<div class="row voffset2" align="center">
							<button class="btn btn-primary btn-sm voffset" type="button" name="calculateR" id="calculateR">
								<i class="fa fa-list fa-lg"></i> Calculate
							</button>
							<button class="btn btn-primary btn-sm voffset" type="button" name="printListR" id="printListR">
